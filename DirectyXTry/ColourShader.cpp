...
ColourShader::ColourShader(const ColourShader &)
{
}
...
bool ColourShader::Initialise(ID3D11Device *device, HWND hwnd)
{
	bool result;

	// Initialize the vertex and pixel shaders.

//c:\Users\Elean\source\repos\DirectyXTry\DirectyXTry\color.ps
	//c:\Users\Elean\source\repos\DirectyXTry\DirectyXTry\color.vs

	result = InitialiseShader(device, hwnd, L"../DirectyXTry/color.vs", L"../DirectyXTry/color.ps");
	if (!result)
	{
		return false;
	}
...
bool ColourShader::InitialiseShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
	...
	XMMATRIX projectionMatrix)
{
	...
	//need to transpose matrices before sending to shader
